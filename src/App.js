...
function Banner() {
  return (
    <div className="flex py-12 md:py-14 border flex-col md:flex-row md:justify-between md:max-w-6xl px-8 mx-auto items-center">
      {/* hero */}
      <Hero />
  ...
  return (
    <section className="flex justify-center md:order-2">
      <img
        ...
        alt="hero"
        className="w-[350px] md:w-[450px]  border"
      />
    </section>
  );
}
